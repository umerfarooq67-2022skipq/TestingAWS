...
def lambdaHandlerWebHealth(event, context):
    ...
    for url in WEB_URLS:
        ...
        cw.putMetricData(URL_NAMESPACE, URL_METRIC_NAME_AVAILABILITY, dimensions, availability)
        
        # Storing latency in seconds.
        latency = checkResponseTime(url, http)
        cw.putMetricData(URL_NAMESPACE, URL_METRIC_NAME_LATENCY, dimensions, latency)
